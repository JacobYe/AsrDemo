package com.jacobye.asr.recognizer;
 ...
 */
public class AliyunRecognizer implements NlsListener {
    private static NlsClient client = new NlsClient();

    public AliyunRecognizer() {
    ...
    public void startAsr(AudioInputStream ais) {
        System.out.println("=== Start ASR ===");
        //开始发送语音
//        System.out.println("open audio file...");
        FileInputStream fis = null;
        try {
            String filePath = "src/main/resources/sample.pcm";
...
//            System.out.println("create NLS future");
            try {
                ...
                req.authorize("LTAIYKsMysV8zbRS", "3AiAsjwQ51C9kScA1FdxBpubO1vQqs"); // 请替换为用户申请到的Access Key ID和Access Key Secret
...
//            System.out.println("calling NLS service end");
    ...
    public static void main(String[] args) {
        AliyunRecognizer demo = new AliyunRecognizer();
        demo.startAsr(null);
        demo.shutDown();
    }
}
